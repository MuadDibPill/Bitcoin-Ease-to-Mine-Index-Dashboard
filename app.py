...
# ============================================
# COLOR PALETTE - ORIGINAL BRIGHTER TONES
# ============================================
COLORS = {
    'primary': '#2E5BFF',
    'secondary': '#FF9F2E',
...
<style>
    ...
    /* Adjusted top padding - slightly more than before */
    .block-container {
...
# ============================================
# HELPER FUNCTIONS - ORIGINAL BRIGHTER COLORS
# ============================================
def get_score_color_bright(score, min_score, max_score):
    ...
    # Original bright gradient: Red -> Orange -> Yellow -> Green -> Blue
    if ratio < 0.5:
        t = ratio * 2
        r = 255
        g = int(46 + (217 - 46) * t)
...
if page == "Overview":
    ...
    # ========================================
    # WORLD MAP - TALLER, ORIGINAL COLORS
    # ========================================
    df_map = df.copy()
    ...
    # ========================================
    # EMI RANKING BAR CHART (NO HASHRATE)
    # ========================================
...
# ============================================
    ...
    weights = [
        ...
        ("Operating Conditions", 5, "#8B5CF6", "white")
    ]
