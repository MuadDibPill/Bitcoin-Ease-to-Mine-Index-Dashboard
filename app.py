...
<style>
    ...
    /* KPI Cards for creative overview */
    .kpi-card {
...
with st.sidebar:
    ...
    page = st.radio("", ["Overview", "Overview (Creative)", "Methodology"], label_visibility="collapsed")
...
# ============================================
# OVERVIEW PAGE (CREATIVE ALTERNATIVE)
# ============================================
    ...
    with col2:
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-label">Average EMI Score</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div class="kpi-card-neutral">
            <div class="kpi-value">{total_hashrate:.0f}</div>
            <div class="kpi-label">Total Hashrate (EH/s)</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col4:
        st.markdown(f"""
        <div class="kpi-card">
            <div class="kpi-value">{top_country['Index_Score']:.2f}</div>
            <div class="kpi-label">🏆 {top_country['Country']}</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col5:
        ...
        <div class="kpi-card-warning">
            <div class="kpi-value">{bottom_country['Index_Score']:.2f}</div>
            <div class="kpi-label">⚠️ {bottom_country['Country']}</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_top5:
        st.markdown('<p class="section-title">Top 5 Jurisdictions</p>', unsafe_allow_html=True)
        ...
        for i, row in df_sorted.head(5).iterrows():
            ...
            <div style="background: linear-gradient(90deg, {color}22 0%, transparent 100%); 
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <span style="font-weight: 700; color: #1E293B;">#{rank} {row['Country']}</span>
                        <span style="color: #64748B; font-size: 0.85rem; margin-left: 8px;">{row['Region']}</span>
                    </div>
                    <div style="font-weight: 700; font-size: 1.2rem; color: {color};">{row['Index_Score']:.2f}</div>
                </div>
        ...
        st.markdown("")
        st.markdown('<p class="section-title" style="margin-top: 1rem;">Bottom 3 Jurisdictions</p>', unsafe_allow_html=True)
        ...
        for i, row in df_sorted.tail(3).iloc[::-1].iterrows():
            ...
            <div style="background: linear-gradient(90deg, {color}22 0%, transparent 100%); 
                        ...
                        border-radius: 0 8px 8px 0;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="font-weight: 600; color: #1E293B; font-size: 0.9rem;">#{rank} {row['Country']}</span>
                    <span style="font-weight: 700; color: {color};">{row['Index_Score']:.2f}</span>
                </div>
            </div>
            """, unsafe_allow_html=True)
    ...
    # ========================================
    # BUBBLE CHART: HASHRATE VS EMI SCORE
    # ========================================
...
# ============================================
    ...
    # ========================================
    # WEIGHTING STACKED BAR CHART - NO ARROW
    # ========================================
